...
class EfficiencyController : public ButtonController {
  ...
  Q_PROPERTY(QVector<qreal> packSegments READ packSegments WRITE setPackSegments
                 NOTIFY packSegmentsChanged FINAL)
  Q_PROPERTY(qreal maxCellTemp READ maxCellTemp WRITE setMaxCellTemp NOTIFY
                 maxCellTempChanged FINAL)
  Q_PROPERTY(int stateOfCharge READ stateOfCharge WRITE setStateOfCharge NOTIFY
                 stateOfChargeChanged FINAL)
  Q_PROPERTY(qreal inverterTemp READ inverterTemp WRITE setInverterTemp NOTIFY
                 inverterTempChanged FINAL)
  Q_PROPERTY(qreal motorTemp READ motorTemp WRITE setMotorTemp NOTIFY
                 motorTempChanged FINAL)
  Q_PROPERTY(qreal averageCellTemp READ averageCellTemp WRITE setAverageCellTemp
                 NOTIFY averageCellTempChanged FINAL)
