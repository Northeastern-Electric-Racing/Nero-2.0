...
EfficiencyController::EfficiencyController(QObject *parent)
    : QObject{parent}
    , m_currentMaxTorque(0)
    , m_currentRegenStrength(0)
    , m_packSegments({0, 0, 0, 0})
    , m_maxCellTemp(0)
    , m_stateOfCharge(0)
    , m_inverterTemp(0)
    , m_motorTemp(0)
...
qreal EfficiencyController::maxCellTemp() const
{
...
int EfficiencyController::stateOfCharge() const
{
...
qreal EfficiencyController::inverterTemp() const
{
  return m_inverterTemp;
}
...
qreal EfficiencyController::motorTemp() const
{
  return m_motorTemp;
}
